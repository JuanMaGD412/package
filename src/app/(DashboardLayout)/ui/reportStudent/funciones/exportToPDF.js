...
export async function exportToPDF(estudiante, casos) {
  const doc = new jsPDF();
  ...
  // Línea divisoria después de la tabla del estudiante
  ...
  // Línea divisoria antes de los casos
  ...
  doc.setDrawColor(180);
  doc.line(14, finalY - 8, 196, finalY - 8); // Línea divisoria antes de las firmas
  ...
  doc.save(`Reporte_${estudiante.documentoid}.pdf`);
}
